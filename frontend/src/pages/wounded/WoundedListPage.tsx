...
export default function WoundedListPage() {
  ...
  const handleSearch = useCallback(
    (values: Record<string, unknown>) => {
      ...
      if (values.woundType) params.woundType = values.woundType as string;
  ...
  const columns: ColumnsType<WoundedRecord> = [
    ...
    { title: '보훈청', dataIndex: 'veteransOfficeName', key: 'veteransOfficeName', width: 100 },
    { title: '병명', dataIndex: 'diseaseName', key: 'diseaseName', width: 120 },
    { title: '상이구분', dataIndex: 'woundTypeLabel', key: 'woundTypeLabel', width: 90 },
    {
      title: '상태',
      dataIndex: 'status',
      key: 'status',
